...
CreateConVar( "mm_mode", "1", FCVAR_NONE, "Switches between modes. 1-Parkour, 2-Grapple, 3-Radioskate, 4-VQ3, 5-CPMA")
...
hook.Add("SetupMove", "Core_Movement", function(ply, mv, cmd)
  ...
  if ply:top_speed() < ply:Speed2D() then
    ply:top_speed(ply:Speed2D())
  end
